...
angular.module('customLoginApp')
    .controller('authenticationController', ['$scope', '$window', 'Facebook', function ($scope, $window, Facebook) {
        ...
        $scope.loginToLinkedIn = function () {
            $window.location = "https://www.linkedin.com/uas/oauth2/authorization?response_type=code&client_id=751qa1artclf9k&scope=r_basicprofile%20r_emailaddress&redirect_uri=http%3A%2F%2Flocalhost:8088%2Fauthorization%2Flinkedin&state=logi345n";
            //, 'popUpWindow','height=700,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes'
        };
